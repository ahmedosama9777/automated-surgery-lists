...
<div id="wrapper">
	<div id="header-wrapper">
		<div id="header">
			...
			<div id="menu">
				<ul>
					<li class="current_page_item"><a href="#"> عرض جميع الغرف </a></li>
				...
				<div id="content">
					<div class="post">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3" ><label for="text-input" class=" form-control-label" ><a href="SurgeryRooms/roomFromView?roomid={{$Room->RoomId}}">      غرفة  {{$Room->RoomId}}      </a> |   عمليات <small>{{$Room->Operation}} </small></label></div>
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label" ><small> {{$Room->created_at}} </small></label></div>
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label" ><p> حالة الغرفة: {{$Room->Validity_Status_Comment}} </p></label></div>
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label" ><p>  {{$Room->Availability_Status_Comment}}  </p></label></div>
